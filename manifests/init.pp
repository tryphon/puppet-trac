...
class trac {
  ...
  file { "/etc/trac/trac.defaults":
    source => "puppet:///modules/trac/trac.defaults",
  ...
  file { "/etc/trac/trac.ini":
    source => ["puppet:///files/trac/trac.ini", "puppet:///modules/trac/trac.ini"],
  ...
  file { "/usr/share/trac/hooks/git-post-receive-hook":
    source => "puppet:///modules/trac/git-post-receive-hook",
    mode => 755
  }
  ...
  file { "/usr/local/bin/trac-robotstxt":
    source => "puppet:///modules/trac/trac-robotstxt",
    mode => 755
  }
...
class trac::www::basic {
  ...
  apache2::confd_file { trac:
    source => "puppet:///modules/trac/apache2.conf",
